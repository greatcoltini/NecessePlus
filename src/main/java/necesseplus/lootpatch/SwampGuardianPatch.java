...
//  */
@ModMethodPatch(target = SwampGuardianBody.class, name = "getLootTable", arguments = {})
public class SwampGuardianPatch {
        @Advice.OnMethodExit
        static void onExit(@Advice.This SwampGuardianBody swampGuardianBody, @Advice.Return LootTable lootTable) {
            lootTable.items.add(new ChanceLootItem(0.5f, "swampguardianskin"));
    }
}
