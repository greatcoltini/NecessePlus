...
public class PirateCaptainPatch {
        @Advice.OnMethodExit
        static void onExit(@Advice.This PirateCaptainMob pirateCaptainMob, @Advice.Return LootTable lootTable) {
            lootTable.items.add(new ChanceLootItem(0.5f, "piratecaptainflag"));
    }
}
