...
public class AncientVulturePatch {
        @Advice.OnMethodExit
        static void onExit(@Advice.This AncientVultureMob ancientVultureMob, @Advice.Return LootTable lootTable) {
            lootTable.items.add(new ChanceLootItem(0.5f, "ancientvulturehead"));
    }
}
