...
public class PirateCaptainTrophyObject extends FurnitureObject {

    private GameTexture texture;

    public PirateCaptainTrophyObject() {
    ...
    public void loadTextures() {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/piratecaptaintrophyobject");
    }
