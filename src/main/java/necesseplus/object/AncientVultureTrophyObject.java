...
public class AncientVultureTrophyObject extends FurnitureObject {

    private GameTexture texture;

    public AncientVultureTrophyObject() {
    ...
    public void loadTextures() {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/ancientvulturetrophyobject");
    }
