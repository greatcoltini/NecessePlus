...
public class SwampGuardianTrophyObject extends FurnitureObject {

    private GameTexture texture;

    public SwampGuardianTrophyObject() {
    ...
    public void loadTextures() {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/swampguardiantrophyobject");
    }
